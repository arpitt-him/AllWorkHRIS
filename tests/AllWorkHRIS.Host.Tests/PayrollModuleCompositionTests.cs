...
public sealed class PayrollModuleCompositionTests
{
    ...
    public void PayrollModule_Register_WiresAllExpectedServiceInterfaces()
    {
        ...
        Assert.True(container.IsRegistered<IEarningsCodeRepository>(),        "IEarningsCodeRepository");
    ...
    public void PayrollModule_GetMenuContributions_ReturnsExpectedItems()
    {
        ...
        // Seven items: one parent + six children
        Assert.Equal(7, contributions.Count);
        ...
        Assert.Contains(contributions, c =>
            c.Label == "Tax Profiles" &&
            c.Href  == "/payroll/tax-profiles" &&
            c.RequiredRole == "PayrollAdmin,PayrollOperator");
    }
